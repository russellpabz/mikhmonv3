...
<?php 
  ...
  <a <?= displayNoneAdmin(); ?> href="./admin.php?id=about" class="menu <?= $sabout; ?>"><i class="fa fa-info-circle"></i> <?= $_about ?></a>
...
<div id="sidenav" class="sidenav">
  <div class="menu text-center align-middle card-header" style="border-radius:0;"><h3 style="text-transform: uppercase;"><?= $_SESSION["mikhmon"]; ?></h3></div>
